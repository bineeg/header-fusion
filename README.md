...
<p>To use the extension, log into the application with two different accounts (e.g., User A and User B). Collect the relevant access control headers (e.g., <code>X-Header-Name: Value</code>) and configure them in the UI . Then, send the request to the extension to automate the header swapping.</br>
<a href="https://medium.com/@bineeg/header-fusion-3c11da41582e">
Installation and Usage</a></p>
